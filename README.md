...
- [ ] Add some sort of validation for `--model-id` and `--model-dir` to make sure that those are either valid Hugging Face Hub model IDs or local directories, respectively
