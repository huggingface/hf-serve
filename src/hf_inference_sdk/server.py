...
from hf_inference_sdk.routers import (
    custom_router,
    health_router,
    metrics_router,
...
def launch(
    ...
    if cloud is not None and cloud == "google":
        from hf_inference_sdk.compatibility.google.routers.health import router as google_health_router
    ...
    match task:
        ...
        case "image-text-to-text":
            from hf_inference_sdk.tasks.transformers.image_text_to_text import (
                ImageTextToText,
        ...
        case "text-generation" | "text2text-generation" | "conversational":
            from hf_inference_sdk.tasks.transformers.text_generation import (
                TextGeneration,
                TextGenerationInput,
        ...
        case "feature-extraction" | "sentence-embeddings" | "embeddings":
            from hf_inference_sdk.tasks.sentence_transformers.feature_extraction import (
                FeatureExtraction,
        ...
        case "text-ranking" | "sentence-ranking":
            from hf_inference_sdk.tasks.sentence_transformers.text_ranking import (
                TextRanking,
                TextRankingInput,
                TextRankingOutput,
            )
        ...
        case "text-classification":
            from hf_inference_sdk.tasks.transformers.text_classification import (
                TextClassification,
        ...
        case "fill-mask":
            from hf_inference_sdk.tasks.transformers.fill_mask import (
                FillMask,
                FillMaskInput,
                FillMaskOutput,
            )
        ...
        case "token-classification":
            from hf_inference_sdk.tasks.transformers.token_classification import (
                TokenClassification,
        ...
        case "table-question-answering":
            from hf_inference_sdk.tasks.transformers.table_question_answering import (
        ...
        case "zero-shot-audio-classification":
            from hf_inference_sdk.tasks.transformers.zero_shot_audio_classification import (
            ...
            predictor = _lazy(
                lambda: ZeroShotAudioClassification(
                    model_id=model_id or model_dir,  # type: ignore
                    revision=revision,
                    dtype=dtype,
                    device=device,  # type: ignore
        ...
        case "audio-classification":
            from hf_inference_sdk.tasks.transformers.audio_classification import (
                AudioClassification,
        ...
        case "asr" | "automatic-speech-recognition":
            ...
            predictor = _lazy(
                lambda: AutomaticSpeechRecognition(
                    model_id=model_id or model_dir,  # type: ignore
                    revision=revision,
                    dtype=dtype,
                    device=device,  # type: ignore
        ...
        case "object-detection":
            ...
            match cloud:
                ...
                case _:
                    from hf_inference_sdk.tasks.transformers.object_detection import ObjectDetectionFormInput
        ...
        case "zero-shot-image-classification":
            ...
            predictor = _lazy(
                lambda: ZeroShotImageClassification(
                    model_id=model_id or model_dir,  # type: ignore
                    revision=revision,
                    dtype=dtype,
                    device=device,  # type: ignore
        ...
        case "mask-generation":
            from hf_inference_sdk.tasks.transformers.mask_generation import (
                MaskGeneration,
                MaskGenerationInput,
            ...
            match cloud:
                ...
                case _:
                    from hf_inference_sdk.tasks.transformers.mask_generation import MaskGenerationFormInput
        ...
        case "custom":
            ...
            from hf_inference_sdk.tasks.custom import Custom
    ...
    if cloud is not None and cloud == "azure":
        from hf_inference_sdk.compatibility.azure import router as azure_router
