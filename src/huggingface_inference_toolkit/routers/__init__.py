...
from huggingface_inference_toolkit.routers.openai.chat_completions import router as chat_completions_router
from huggingface_inference_toolkit.routers.predict import router as predict_router

__all__ = ["chat_completions_router", "custom_router", "health_router", "metrics_router", "predict_router"]
