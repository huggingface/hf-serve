...
from huggingface_inference_toolkit.routers.predict_media import media_router as predict_media_router

__all__ = ["custom_router", "health_router", "metrics_router", "predict_media_router", "predict_router"]
